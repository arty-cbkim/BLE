...
public class BLEConnActivity extends ListActivity {
    private final static String TAG = BLEConnActivity.class.getSimpleName();
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = BLEConnActivity.this.getLayoutInflater();
        }
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                viewHolder.deviceName = (TextView) view.findViewById(R.id.txtDevice);
                viewHolder.deviceAddress = (TextView) view.findViewById(R.id.txtMacAddress);
